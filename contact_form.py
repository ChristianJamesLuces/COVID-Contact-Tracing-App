...
class TracingForm():
    ...
    def user_information(self):
      ...
      #Get date
      date = Label(self.user_information_window, text="Date is:", font=("Arial", 9, "bold"))
      date.grid(row=6, column=0, padx=5, pady=10)

      month = Label(self.user_information_window, text="Month:")
      month.grid(row=6, column=1, padx=5, pady=10)
      entry_month = Spinbox(self.user_information_window, from_=0, to=12)
      entry_month.grid(row=6, column=2, padx=5, pady=10)

      day = Label(self.user_information_window, text="Day:")
      day.grid(row=6, column=3, padx=5, pady=10)
      entry_day = Spinbox(self.user_information_window, from_=0, to=31)
      entry_day.grid(row=6, column=4, padx=5, pady=10)

      year = Label(self.user_information_window, text="Year:")
      year.grid(row=6, column=5, padx=5, pady=10)
      entry_year= Spinbox(self.user_information_window, from_=2019, to=2023)
      entry_year.grid(row=6, column=6, padx=5, pady=10)
